...
execute if predicate {condition:"minecraft:any_of",terms:[{condition:"minecraft:value_check",value:{type:"minecraft:score",score:"nitBossTime",target:"this"},range:24},{condition:"minecraft:value_check",value:{type:"minecraft:score",score:"nitBossTime",target:"this"},range:48},{condition:"minecraft:value_check",value:{type:"minecraft:score",score:"nitBossTime",target:"this"},range:72},{condition:"minecraft:value_check",value:{type:"minecraft:score",score:"nitBossTime",target:"this"},range:96},{condition:"minecraft:value_check",value:{type:"minecraft:score",score:"nitBossTime",target:"this"},range:120}]} anchored eyes rotated ~ ~ positioned ^ ^ ^1.25 summon item_display run function nitdim:boss/attacks/rexial/flame_projectile_b
