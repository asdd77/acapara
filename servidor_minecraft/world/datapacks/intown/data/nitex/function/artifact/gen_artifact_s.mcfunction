...
execute if score @s nitRandom matches 1 run place template nitex:artifact/oasis_old ~-7 ~-3 ~16
execute if score @s nitRandom matches 2 run place template nitex:artifact/glass_old ~-7 ~-3 ~16
execute if score @s nitRandom matches 3 run place template nitex:artifact/cactus_old ~-7 ~-3 ~16
execute if score @s nitRandom matches 4 run place template nitex:artifact/obsidian_old ~-7 ~-3 ~16
